...
ALLOWED_AST_NODES = """Add And Assign Attribute AugAssign AugLoad AugStore BinOp BitAnd
    BitOr BitXor BoolOp Break Call ClassDef Compare Constant Continue Del Delete Dict
    DictComp Div Ellipsis Eq ExceptHandler Expr Expression ExtSlice FloorDiv For
    FunctionDef GeneratorExp Gt GtE If IfExp In Index Interactive Invert Is IsNot
    JoinedStr LShift Lambda List ListComp Load Lt LtE Mod Module Mult Name NameConstant
